...
<template>
  <div class="space-y-3">
      ...
      <div class="w-full space-y-2 pt-2">
        ...
        <div class="relative">
          <input
            ...
            name=""
            id=""
            class="w-full pr-4 pl-12 py-2 border border-gray-300 text-base rounded-lg"
            placeholder="search customer"
          />
          <MagnifyingGlassIcon
            class="w-4 h-4 absolute text-[#ff613c] top-3 left-4"
          />
        </div>
    ...
    <div class="relative bg-white px-3 pb-3 border-t border-gray-300">
