<template>
  <div>
    ...
    <div
      v-if="loading"
      class="w-full h-[88vh] flex justify-center items-center bg-white rounded-2xl"
    >
    ...
    >
      <!-- Header -->
      <div
        class="flex justify-between items-start pb-4 sm:pb-6"
        style="border-bottom: 1px solid #d1d5db"
      >
        <div class="pr-2">
          <p
            class="text-main mb-2 text-2xl font-semibold text-slate-800 truncate"
          >
            Availabilities
          </p>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-5">
        ...
        >
          ...
          <div
            class="flex sm:flex-col gap-2 overflow-x-auto sm:overflow-x-visible py-1"
          >
            <div
            ...
            >
              <p
                class="text-lg sm:text-base font-medium text-gray-800 truncate"
                :title="room.name"
              >
        ...
        <div
          class="sm:col-span-2 sm:h-[70vh] overflow-y-auto pb-20 px-0 sm:px-4"
        >
          <div
            v-if="showSuccess"
            ...
            <div class="text-center">
              <div class="relative inline-block mb-4 sm:mb-6">
                <div class="absolute inset-0 flex items-center justify-center">
                  <div
                    class="w-16 h-16 sm:w-20 sm:h-20 bg-green-500/20 rounded-full animate-ping"
                  ></div>
                </div>
                <div class="absolute inset-0 flex items-center justify-center">
                  <div
                    class="w-12 h-12 sm:w-16 sm:h-16 bg-green-500/30 rounded-full animate-pulse"
                  ></div>
                </div>

                <div
                  class="relative bg-white rounded-full p-3 sm:p-4 shadow-lg animate-scale-in"
                >
                  <CheckIcon
                    class="w-8 h-8 sm:w-12 sm:h-12 text-green-500 animate-check-draw"
                  />
                </div>
              </div>
              ...
              <!-- Success Message -->
              <div
                class="mb-6 sm:mb-8 animate-fade-in-up"
          ...
          >
            <div class="text-center text-gray-400 px-4">
              ...
              <p class="text-xs sm:text-sm">
                Select a room to create availability
              </p>
            </div>
          </div>
