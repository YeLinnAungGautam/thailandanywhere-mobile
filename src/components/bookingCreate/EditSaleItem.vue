...
onMounted(() => {
  ...
  formitem.value.quantity = props.data.quantity;
  formitem.value.comment = props.data.comment;
  formitem.value.days = props.data.days;
  formitem.value.checkin_date = props.data.checkin_date;
  formitem.value.checkout_date = props.data.checkout_date;
  formitem.value.pickup_location = props.data.pickup_location;
  ...
  todayVali.value = true;
  formitem.value.individual_pricing = props.data.individual_pricing;
  formitem.value.total_amount = props.data.total_amount;
  formitem.value.total_cost_price = props.data.total_cost_price;
  formitem.value.child_info = props.data.child_info;

  if (props.data.product_id) {
    formitem.value.product_id = props.data.product_id;
    chooseType();
  }

  if (props.data.car_id) {
    formitem.value.car_id = props.data.car_id;
    carType.value = props.data?.car_list;
    chooseCar(formitem.value.product_id);
  }
  if (props.data.room_id) {
    formitem.value.room_id = props.data.room_id;
